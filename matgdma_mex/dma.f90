...
REAL(dp) :: bigexp
REAL(dp), PARAMETER :: bigexp_default=0.0
...
!  SWITCH exp
!          If the sum of gaussian exponents for a pair of primitives
...
!  LIMIT l
!          Set the rank limit to l for all atoms.
!  LIMIT l [site site ...]
!          Set the rank limit to l for the specified atoms.
!  LIMIT l ALL a
...
!  RADIUS [ALL] name radius [ALL] name radius ...
!          Set the relative radius to the given value for sites with the
!          specified name, or (if ALL is specified) for sites with names
